...
def generate_molecule_report(
    ...
    pred_data = [
        ...
        ['Prediction Class', prediction_data['prediction_class'].replace('_', ' ').title()],
    ...
    confidence_text = f"Confidence in this prediction: {prediction_data['confidence_score']:.1%}"

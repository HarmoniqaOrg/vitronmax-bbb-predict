...
class BBBPredictor:
    ...
    def predict_single(self, smiles: str) -> Tuple[float, str, float, np.ndarray]:
        ...
        probability = self.model.predict_proba(fp_reshaped)[0, 1]  # Probability of class 1 (permeable)
    ...
    def predict_batch(self, smiles_list: List[str]) -> List[Tuple[float, str, float, np.ndarray]]:
